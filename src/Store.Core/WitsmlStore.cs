...
namespace PDS.WITSMLstudio.Store
{
    ...
    public class WitsmlStore : IWitsmlStore
    {
        ...
        private static string s_connectionString = "HostName=witsml.azure-devices.net;DeviceId=1;SharedAccessKeyName=iothubowner;SharedAccessKey=2MXT0fiXxlpJFx7KSGI6cqETFWwWYDPQk6maaKfb7oA=";
        ...
        private void SendTo_IoTHub(string xmlin)
        {
            
            //string msg = JsonConvert.SerializeObject(xmlin, Formatting.Indented);
            string msg = xmlin;
